        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <div className="flex items-center gap-1">
                    <Link to="/"><img src={lo} alt="" className=" size-7 md:size-8 lg:size-10" /></Link>
                    <Link to="/" className="md:text-2xl lg:text-2xl font-bold">JobHub</Link>
                </div>
            </div>
                ...
                </label>
                {
                    user ?
                        <div className="flex gap-1 items-center">
                            ...
                            <button onClick={handleSignOutUser} className="btn btn-accent btn-sm md:btn-md lg:btn-md text-base md:text-lg lg:text-lg">Sign Out</button>
                        </div>
                        :
